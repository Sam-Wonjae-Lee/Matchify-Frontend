...
const EventCard: React.FC<EventCardProps> = ({ eventName, eventDate, eventLocation, eventImage,
    friendImage1, friendImage2, friendName1, friendName2, additionalCount
}) => {
    return (
        <div 
            className="relative bg-cover bg-center shadow-md w-full max-w-sm h-64"
            style={{ 
        ...
        >
            <div className="absolute inset-0 bg-black opacity-50"></div> {/* Increased opacity */}
